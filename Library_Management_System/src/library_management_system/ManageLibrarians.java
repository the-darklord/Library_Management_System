...
public class ManageLibrarians extends javax.swing.JFrame {
    ...
    public void setLibrarianDetailsToTable(){
        ...
        try{
            ...
            while(rs.next()){
                String librarianid = rs.getString(1);
                String name = rs.getString(2);
                String gender = rs.getString(3);
                String mobilenumber = rs.getString(4);
                String address = rs.getString(5);
                
                Object[] obj ={librarianid,name,gender,mobilenumber,address};
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library_management_system/4219053.jpg"))); // NOI18N
